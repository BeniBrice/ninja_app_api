...
class TelephonePage extends StatefulWidget {
  const TelephonePage({super.key, required this.country});
  final String country;
                          ...
                          child: Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  // row.textWidget(
                                  //   "format national",
                                  //   data['format_national'] ?? "",
                                  //   Colors.white,
                                  // ),
                                  // row.textWidget(
                                  //   "format international",
                                  //   data['format_international'] ?? "",
                                  //   Colors.white,
                                  // ),
                                  // row.textWidget(
                                  //   "format actuel",
